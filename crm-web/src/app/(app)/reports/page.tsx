...
export default function ReportsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'day_end' | 'matrix_report' | 'retention' | 'daily_audit' | 'registrations' | 'bank_revenue' | 'debts'>('day_end')
  ...
  async function loadAllReportData() {
    ...
    try {
      ...
      // 2. Fetch monthly data, day-end registrations, prev month payments & debts in parallel
      const [
        { data: registeredData },
